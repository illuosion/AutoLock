...
// HADDR比FSMC多一位  访问A0实质是访问内部HADDR地址的第（0+1）位为1即可  0x68000000|=（1<<((0+1))=0x6800 0002
//  FSMC_Bank1_NORSRAM用于LCD命令操作的地址
#define FSMC_Addr_ILI9806G_CMD ((uint32_t)0x68000000)

// FSMC_Bank1_NORSRAM用于LCD数据操作的地址
#define FSMC_Addr_ILI9806G_DATA ((uint32_t)0x68000002) // 0x68000000|=（1<<((0+1))=0x6800 0002
...
/******控制信号线******/
#define FSMC_AF GPIO_AF_FSMC // 引脚复用
// 片选，选择NOR/SRAM块
